...
if ($modo=="cad")
{
	$visual->assign('subtitulo','Cadastro de Tipo de Grupo');
	$visual->assign('botao','Cadastrar');
	$visual->assign('modo',$modo);
	$visual->display('adm/grupos_tipos_formulario.tpl');
}
else if ($modo=="alt")
{
	$visual->assign('subtitulo','Alteração de Tipo de Grupo');
...
else if($modo=="lst")
{
	...
	$visual->assign('subtitulo','Manutenção de Tipos de Grupos');
	$visual->assign('dados',$dados);
	$visual->display('adm/grupos_tipos_listagem.tpl');
}
//}
