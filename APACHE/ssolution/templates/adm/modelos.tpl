...
<input type="hidden" name="id" value="{$valores.id}">
	...
	<tr>
		...
		<td class="campos">
			<input type="radio" name="exibir" id="exibir_nao" value="0" class="" style="" />
			<label for="exibir_nao">N&atilde;o</label>
			<input type="radio" name="exibir" id="exibir_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos" width="50%"><input name="nome" type="text" class="" style="" value="{$valores.nome}" size="45" /></td>
	...
	<tr>
	  ...
	  <td class="campos">
			...
			<input type="text" name="nascimento" onclick="scwShow(this,this);" value="{$valores.nascimento|date_format:"%d/%m/%Y"}" class="" style="" />
	...
	<tr>
		...
		<td class="campos"><input name="filiacao" type="text" class="" style="" value="{$valores.filiacao}" size="45" /></td>
	...
	<tr>
		...
		<td class="campos"><input name="responsavel" type="text" class="" style="" value="{$valores.responsavel}" size="45" /></td>
	...
	<tr>
		...
		<td class="campos"><input name="endereco" type="text" class="" style="" value="{$valores.endereco}" size="45" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">Bairro:</td>
		<td class="campos"><input name="bairro" type="text" class="" style="" value="{$valores.bairro}" size="45" /></td>
	</tr>

	<tr>
		<td class="rotulos">CEP:</td>
		<td class="campos"><input name="cep" type="text" class="" style="" value="{$valores.cep}" size="45" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">Telefone:</td>
		<td class="campos"><input type="text" name="telefone" value="{$valores.telefone}" class="" style="" /></td>
	</tr>

	<tr>
		<td class="rotulos">Celular:</td>
		<td class="campos"><input type="text" name="celular" value="{$valores.celular}" class="" style="" /></td>
	</tr>

	<tr>
		<td class="rotulos">E-mail:</td>
		<td class="campos"><input type="text" name="email" value="{$valores.email}" class="" style="" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">RG:</td>
		<td class="campos"><input type="text" name="rg" value="{$valores.rg}" class="" style="" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">CPF:</td>
		<td class="campos"><input type="text" name="cpf" value="{$valores.cpf}" class="" style="" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">Telefone Recados:</td>
		<td class="campos"><input type="text" name="tel_recado" value="{$valores.tel_recado}" class="" style="" /></td>
	</tr>
	
	<tr>
		<td class="rotulos">MSN:</td>
		<td class="campos"><input type="text" name="msn" value="{$valores.msn}" class="" style="" /></td>
	</tr>

	<tr>
		<td class="rotulos">Booker:</td>
		<td class="campos"><input name="booker" type="text" class="" style="" value="{$valores.booker}" size="45" /></td>
	</tr>
	...
	<tr>
	  ...
	  <td class="campos">
			...
			<input type="text" name="cadastro" onclick= "scwShow(this,this)" onfocus="scwShow(this,this)" value="{$valores.cadastro|date_format:"%d/%m/%Y"}" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="semcache" id="semcache_nao" value="0" class="" style="" />
		...
		<input type="radio" name="semcache" id="semcache_sim" value="1" class="" style="" />
...
&nbsp;		</td>
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="cachebaixo" id="cachebaixo_nao" value="0" class="" style="" onClick="mostracampos('cachebaixo');" />
		<label for="cachebaixo_nao">N&atilde;o</label>
		<input type="radio" name="cachebaixo" id="cachebaixo_sim" value="1" class="" style="" onClick="escondecampos('cachebaixo');" />
		<label for="cachebaixo_sim">Sim</label>
		<div id="cachebaixo_div" style="display:none">
			<span class="rotulos">Quanto:</span>
			&nbsp;
			<input type="text" name="cachebaixo_quanto" value="{$valores.cachebaixo_quanto}" class="" style="" />
		</div>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="esporte" id="esporte_nao" value="0" class="" style="" onClick="escondecampos('esporte');" />
		<label for="esporte_nao">N&atilde;o</label>
		<input type="radio" name="esporte" id="esporte_sim" value="1" class="" style="" onClick="mostracampos('esporte');" />
		<label for="esporte_sim">Sim</label>
		<div id="esporte_div" style="display:none">
			<span class="rotulos">Qual ?</span>
			&nbsp;
			<input type="text" name="esporte_qual" value="{$valores.esporte_qual}" class="" style="" />
		</div>		</td>
	</tr>
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="cavalo" id="cavalo_nao" value="0" class="" style="" />
		<label for="cavalo_nao">N&atilde;o</label>
		<input type="radio" name="cavalo" id="cavalo_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="skate" id="skate_nao" value="skate_nao" class="0" style="" />
		<label for="skate_nao">N&atilde;o</label>
		<input type="radio" name="skate" id="skate_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="patins" id="patins_nao" value="0" class="" style="" />
		<label for="patins_nao">N&atilde;o</label>
		<input type="radio" name="patins" id="patins_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="instrumento" id="instrumento_nao" value="0" class="" style="" onClick="escondecampos('instrumento');" />
		<label for="instrumento_nao">N&atilde;o</label>
		<input type="radio" name="instrumento" id="instrumento_sim" value="1" class="" style="" onClick="mostracampos('instrumento');" />
		<label for="instrumento_sim">Sim</label>
		<div id="instrumento_div" style="display:none">
			<span class="rotulos">Qual ?</span>
			&nbsp;
			<input type="text" name="instrumento_qual" value="{$valores.instrumento_qual}" class="" style="" />
		</div>		</td>
	</tr>
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="moda" id="moda_nao" value="0" class="" style="" />
		<label for="moda_nao">N&atilde;o</label>
		<input type="radio" name="moda" id="moda_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="perfil" id="perfil_nao" value="0" class="" style="" />
		<label for="perfil_nao">N&atilde;o</label>
		<input type="radio" name="perfil" id="perfil_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="canta" id="canta_nao" value="0" class="" style="" />
		<label for="canta_nao">N&atilde;o</label>
		<input type="radio" name="canta" id="canta_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
			<input type="radio" name="danca" id="danca_nao" value="0" class="" style="" onClick="escondecampos('danca');"  />
			<label for="danca_nao">N&atilde;o</label>
			<input type="radio" name="danca" id="danca_sim" value="1" class="" style="" onClick="mostracampos('danca');" />
			<label for="danca_sim">Sim</label>
			<div id="danca_div" style="display:none;">
				<table>
				<tr>
					<td class="rotulos">O que?</td>
					<td class="campos"><input type="text" name="danca_oque" value="{$valores.danca_oque}" class="" style="" /></td>
				</tr>
				</table>
			</div>
		</td>
	...
	<tr>
		...
		<td class="campos">
			<input type="radio" name="atua" id="atua_nao" value="0" class="" style="" />
			<label for="atua_nao">N&atilde;o</label>
			<input type="radio" name="atua" id="atua_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
			<input type="radio" name="drt" id="drt_nao" value="0" class="" style="" onClick="escondecampos('drt');" />
			<label for="drt_nao">N&atilde;o</label>
			<input type="radio" name="drt" id="drt_sim" value="1" class="" style="" onClick="mostracampos('drt');" />
			<label for="drt_sim">Sim</label>
			<div id="drt_div" style="display:none;">
				<table>
				<tr>
					<td class="rotulos">N&uacute;mero:</td>
					<td class="campos"><input type="text" name="drt_numero" value="{$valores.drt_numero}" class="" style="" /></td>
				</tr>
				</table>
			</div>
		</td>
	...
	<tr>
		...
		<input type="radio" name="fotos" id="fotos_nao" value="0" class="" style="" />
		...
		<input type="radio" name="fotos" id="fotos_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="comerciais" id="comerciais_nao" value="0" class="" style="" />
		...
		<input type="radio" name="comerciais" id="comerciais_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="figuracao" id="figuracao_nao" value="0" class="" style="" />
		...
		<input type="radio" name="figuracao" id="figuracao_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="biquini" id="biquini_nao" value="0" class="" style="" />
		...
		<input type="radio" name="biquini" id="biquini_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="lingerie" id="lingerie_nao" value="0" class="" style="" />
		...
		<input type="radio" name="lingerie" id="lingerie_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="seminu" id="seminu_nao" value="0" class="" style="" />
		...
		<input type="radio" name="seminu" id="seminu_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="nu" id="nu_nao" value="0" class="" style="" />
		...
		<input type="radio" name="nu" id="nu_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="makingoff" id="makingoff_nao" value="0" class="" style="" />
		...
		<input type="radio" name="makingoff" id="makingoff_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="jingles" id="jingles_nao" value="0" class="" style="" />
		...
		<input type="radio" name="jingles" id="jingles_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="videoclip" id="videoclip_nao" value="0" class="" style="" />
		...
		<input type="radio" name="videoclip" id="videoclip_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<input type="radio" name="promocao" id="promocao_nao" value="0" class="" style="" />
		...
		<input type="radio" name="promocao" id="promocao_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="feiras" id="feiras_nao" value="0" class="" style="" />
		<label for="feiras_nao">N&atilde;o</label>
		<input type="radio" name="feiras" id="feiras_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="viagens" id="viagens_nao" value="0" class="" style="" onClick="escondecampos('viagens');" />
		<label for="viagens_nao">N&atilde;o</label>
		<input type="radio" name="viagens" id="viagens_sim" value="1" class="" style="" onClick="mostracampos('viagens');" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="elencoapoio" id="elencoapoio_nao" value="0" class="" style="" />
		<label for="elencoapoio_nao">N&atilde;o</label>
		<input type="radio" name="elencoapoio" id="elencoapoio_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="recepcao" id="recepcao_nao" value="0" class="" style="" />
		<label for="recepcao_nao">N&atilde;o</label>
		<input type="radio" name="recepcao" id="recepcao_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="sampling" id="sampling_nao" value="0" class="" style="" />
		<label for="sampling_nao">N&atilde;o</label>
		<input type="radio" name="sampling" id="sampling_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="altura" value="{$valores.altura|replace:".":","}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="peso" value="{$valores.peso|replace:".":","}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="busto" value="{$valores.busto|replace:".":","}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="cintura" value="{$valores.cintura|replace:".":","}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="quadril" value="{$valores.quadril|replace:".":","}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input type="text" name="maos" value="{$valores.maos}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="sapato" value="{$valores.sapato}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input type="text" name="pes" value="{$valores.pes}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos"><input size="5" type="text" name="manequim" value="{$valores.manequim}" class="" style="" /></td>
	...
	<tr>
		...
		<input type="radio" name="piercing" id="piercing_nao" value="0" class="" style="" onClick="escondecampos('piercing');" />
		...
		<input type="radio" name="piercing" id="piercing_sim" value="1" class="" style="" onClick="mostracampos('piercing');" />
		...
		<div id="piercing_div" style="display:none;">
			...
			<table>
				...
				<tr>
					...
					<td class="campos"><input type="text" name="piercing_quantos" value="{$valores.piercing_quantos}" class="" style="" /></td>
				...
				<tr>
					...
					<td class="campos"><input type="text" name="piercing_onde" value="{$valores.piercing_onde}" class="" style="" /></td>
	...
	<tr>
		...
		<input type="radio" name="tatuagem" id="tatuagem_nao" value="0" class="" style="" onClick="escondecampos('tatuagem');" />
		...
		<input type="radio" name="tatuagem" id="tatuagem_sim" value="1" class="" style="" onClick="mostracampos('tatuagem');" />
		...
		<div id="tatuagem_div" style="display:none;">
			...
			<table>
				...
				<tr>
					...
					<td class="campos"><input type="text" name="tatuagem_quantas" value="{$valores.tatuagem_quantas}" class="" style="" /></td>
				...
				<tr>
					...
					<td class="campos"><input type="text" name="tatuagem_onde" value="{$valores.tatuagem_onde}" class="" style="" /></td>
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="mat_fotog" id="mat_fotog_nao" value="0" class="" style="" onClick="escondecampos('mat_fotog');" />
		<label for="mat_fotog_nao">N&atilde;o</label>
		<input type="radio" name="mat_fotog" id="mat_fotog_sim" value="1" class="" style="" onClick="mostracampos('mat_fotog');" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="fezcursoagencia" id="fezcursoagencia_nao" value="0" class="" style="" />
		<label for="fezcursoagencia_nao">N&atilde;o</label>
		<input type="radio" name="fezcursoagencia" id="fezcursoagencia_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td class="campos">
		<input type="radio" name="fezworkshop" id="fezworkshop_nao" value="0" class="" style="" />
		<label for="fezworkshop_nao">N&atilde;o</label>
		<input type="radio" name="fezworkshop" id="fezworkshop_sim" value="1" class="" style="" />
	...
	<tr>
		...
		<td>
			<textarea name="observacoes" class="" style="">{$valores.observacoes}</textarea>
		</td>
	</tr>
	...
	<tr>
	  <td colspan="2" class="rotulos">
		<table width="768" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td>
					<input name="imagem_action" id="imagem_action_0" type="radio" value="0" checked="checked" onclick="document.frm.imagem.disabled=true;" />



					<label for="imagem_action_0">N&atilde;o alterar</label>
					<input name="imagem_action" id="imagem_action_1" type="radio" value="1" onclick="document.frm.imagem.disabled=false;" />
					<label for="imagem_action_1">Alterar</label>
					<input name="imagem_action" id="imagem_action_2" type="radio" value="2" onclick="document.frm.imagem.disabled=true;" />
...
<script>
	...
	if (a.cachebaixo[0].checked) mostracampos("cachebaixo");
	...
	a.viagens_brasil.checked="$valores.viagens_brasil";
	a.viagens_exterior.checked="$valores.viagens_exterior";
	...
	a.mat_fotog_book.checked="{$valores.mat_fotog_book}";
	a.mat_fotog_ensaio.checked="{$valores.mat_fotog_ensaio}";
	a.mat_fotog_fotocad.checked="{$valores.mat_fotog_fotocad}";
	a.mat_fotog_composite.checked="{$valores.mat_fotog_composite}";
	a.mat_fotog_outros.checked="{$valores.mat_fotog_outros}";
