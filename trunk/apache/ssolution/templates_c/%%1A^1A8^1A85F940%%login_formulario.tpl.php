<?php /* Smarty version 2.6.18, created on 2008-08-01 09:20:01
         compiled from adm/login_formulario.tpl */ ?>
...
margin-top: -250px;
'; ?>
background-image:url(<?php echo $this->_tpl_vars['tpl_dir']; ?>
/images/login_box.jpg);<?php echo '
}
...
<div id="errorbox" align="center"><?php echo $this->_tpl_vars['msg']; ?>
</div>
...
<p><label>Usu&aacute;rio:</label>&nbsp;<input type="text" name="login" value="<?php echo $this->_tpl_vars['login']; ?>
"><br />
