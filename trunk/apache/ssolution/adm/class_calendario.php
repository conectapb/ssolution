...
function pad($s, $n) { $r = $s; while (strlen($r) < $n) { $r = "0".$r; } return $r; }
...
class Calendar
{
    ...
    */
    ...
    {
        return "javascript:sel('" . pad($day,2) . "/" . pad($month,2) . "/" . pad($year,4) . "');";
    }
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<table align=\"center\" width=\"228\" cellpading=\"2\" cellspacing=\"1\" class=\"calendar\">\n";
    	$s .= "<tr>\n";
    	$s .= "<td align=\"center\" valign=\"top\"" . (($prevMonth == "") ? ">&nbsp;" : " class=\"PrevNextMonth\"><a href=\"$prevMonth" . "&campo=" . $_REQUEST['campo'] . "\">&lt;&lt;</a>")  . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"calendarCurrent\" colspan=\"5\">$header</td>\n"; 
    	$s .= "<td align=\"center\" valign=\"top\"" . (($nextMonth == "") ? ">&nbsp;" : " class=\"PrevNextMonth\"><a href=\"$nextMonth" . "&campo=" . $_REQUEST['campo'] . "\">&gt;&gt;</a>")  . "</td>\n";
    	$s .= "</tr>\n";
		$s .= "</table>\n";
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
        	    $class = ($year == $today["year"] && $month == $today["mon"] && $d == $today["mday"]) ? "calendarToday" : "calendarNormal";
    	        $s .= "<td style=\"cursor:pointer;\" class=\"$class\" align=\"right\" valign=\"top\">";       
    ...
    */
    ...
    /*
        ...
        represents Sunday.
    */
    var $dayNames = array("Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab");
