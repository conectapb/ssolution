...
{section name=i loop=$dados}
	...
	<tr bgcolor="{cycle values=#FFFFFF,#FAFAFA}">
		<td class="td_content" style="vertical-align:middle" align="center">{if $dados[i].ativo == 1}<img alt="Sim" src="{$tpl_dir}/images/check.jpg" width="14" height="14" border="0" />{else}<img alt="Não" src="{$tpl_dir}/images/block.jpg" width="14" height="14" border="0" />{/if}</td>
